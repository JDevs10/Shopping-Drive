...
public class Register extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void Register1_layout(){
        ...
        ArrayAdapter<CharSequence> arrayAdapter = ArrayAdapter.createFromResource(this, R.array.roles, R.layout.activity_login_spinner_role_custom);
                ...
                if (!roleSet.equals("Select role")) {
                    switch (roleSet) {
                        case "Client":
                            ...
                            if (!firstName_regis_et.getText().toString().isEmpty() && !lastName_regis_et.getText().toString().isEmpty()
                                    && !email_et.getText().toString().isEmpty() && !phoneNumber_et.getText().toString().isEmpty() && !user_regist_pwd_et.getText().toString().isEmpty()) {
                        ...
                        case "Merchant":
                            ...
                            if (!firstName_regis_et.getText().toString().isEmpty() && !lastName_regis_et.getText().toString().isEmpty()
                                    && !email_et.getText().toString().isEmpty() && !phoneNumber_et.getText().toString().isEmpty()
                                    && !user_regist_pwd_et.getText().toString().isEmpty() && !campanyName_et.getText().toString().isEmpty()) {
