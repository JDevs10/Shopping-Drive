...
public class FragmentProfileAddress_Client extends Fragment {
    private String TAG = FragmentProfileAddress_Client.class.getSimpleName();
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_profile_address_client, container, false);
