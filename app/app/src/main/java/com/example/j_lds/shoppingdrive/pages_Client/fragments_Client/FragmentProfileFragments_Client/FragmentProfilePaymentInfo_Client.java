...
public class FragmentProfilePaymentInfo_Client extends Fragment {
    private String TAG = FragmentProfilePaymentInfo_Client.class.getSimpleName();
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_profile_payment_client, container, false);
